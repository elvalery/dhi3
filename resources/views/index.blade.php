        ...
        <div id="contacts" class="col-12 wow fadeInUp">
            <div class="d-flex justify-content-center">
                <form id="callback_form" class="form_callback px-0 px-sm-5 py-4">
                    ...
                    <div class="text-center my-2">
                        <textarea name="name" class="form_textarea border open__light text_size__md c__black brc__metal brc_h__yellow bgc__transparent px-3 py-1" rows="8" cols="80" placeholder="Describe the task"></textarea>
                    </div>
