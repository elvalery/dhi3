...
{{--     page_id="2234950160090811">--}}
{{--</div>--}}
<!-- Google Tag Manager (noscript) -->
<noscript>
  <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TJVB8M8" height="0" width="0"
    ...
    <div class="modal_callback_content animated fadeInUp">
      <div class="col-12">
        <div class="text-right">
          <a href="#" onclick="return false" id="close_callback"
             class="nav-link c__grey c_h__yellow title_size__xl py-0 px-0" style="outline:none;">&times;</a>
        </div>
      </div>
      <div class="col-12 pb-3">
        <div class="d-flex justify-content-center">
          <form id="modal_callback_form" class="form_modal_callback px-0 py-0" method="POST"
                action="{{ route('contacts') }}" enctype="multipart/form-data">
            <h2 class="fira__regular title_size__md text-center">Request a Call</h2>
            <p class="fira__light text_size__md text-center c__black">Leave your contact details and we will guide you
              through the price of our services</p>
            <div class="text-center my-2">
              <label for="modal_callback_user_choise" class="form_label fira__regular text_size__md text-left mx-0">Call
                me</label>
              <select name="description" id="modal_callback_user_choise"
                      class="form_select fira__light text_size__md border brc__metal brc_h__yellow mx-0 py-1 px-2">
                <option class="form_option text_size__md" value="Call me as soon as possible">as soon as possible
                </option>
                <option class="form_option text_size__md modal_callback_tomorrow" value="Call me tomorrow">tomorrow
                </option>
              </select>
            </div>
            <div class="text-right my-2" id="modal_callback_user_time_block" style="display: none">
              <label for="modal_callback_user_time"
                     class="form_label fira__regular text_size__md mx-0 text-left">at</label>
              <select name="time" id="modal_callback_user_time"
                      class="form_select fira__light text_size__md border brc__metal brc_h__yellow py-1 px-2">
            ...
            <div class="text-center my-2">
              <input type="text" name="name"
                     class="form_input fira__light text_size__md border brc__metal brc_h__yellow px-3 py-1"
                     placeholder="Your name">
            </div>
            <div class="text-center my-2">
              <input type="text" id="modal_callback_user_phone" name="phone" required
                     class="form_input fira__light text_size__md border brc__metal brc_h__yellow px-3 py-1"
                     placeholder="+__ (___) ___ __ __">
            </div>
            <div class="text-center my-2">
              <input type="email" name="email" id="modal_callback__user_email"
                     class="form_input fira__light text_size__md border brc__metal brc_h__yellow px-3 py-1"
            ...
            <div class="text-center my-3">
              ...
              <button type="submit"
                      class="button border-0 fira__medium text_size__md c__black bgc__yellow bgc_h__yellow px-5 py-1">
                Request a call
              </button>
            </div>
          </form>
...
<section id="modal_ty_page" class="container-fluid modal_ty_page">
  <div class="container">
    <div class="modal_ty_page_content animated fadeInUp">
      <div class="col-12">
        <div class="text-right">
          <a href="#" onclick="return false" id="close_ty_page"
             class="nav-link c__grey c_h__yellow title_size__xl py-0 px-0" style="outline:none;">&times;</a>
        </div>
      </div>
...
<section id="modal_menu" class="container-fluid modal_menu">
  ...
  <div class="modal_menu_content animated fadeInLeft">
    <ul class="nav d-flex flex-column justify-content-center align-items-start pt-4">
      <li class="nav-item">
        <a href="#services"
           class="nav-link open__regular text_size__md px-0 py-2 mx-3 c__white c_h__white border-bottom brc__transparent">Services</a>
      </li>
      <li class="nav-item">
        <a href="#works"
           class="nav-link open__regular text_size__md px-0 py-2 mx-3 c__white c_h__white border-bottom brc__transparent">Portfolio</a>
      </li>
      <li class="nav-item">
        <a href="#inforgraphic"
           class="nav-link open__regular text_size__md px-0 py-2 mx-3 c__white c_h__white border-bottom brc__transparent">Benefits</a>
      </li>
      <li class="nav-item">
        <a href="#guarantees"
           class="nav-link open__regular text_size__md px-0 py-2 mx-3 c__white c_h__white border-bottom brc__transparent">Warranties</a>
      </li>
{{--      <li class="nav-item">--}}
      {{--        <a href="#download"--}}
      {{--           class="nav-link open__regular text_size__md px-0 py-2 mx-3 c__white c_h__white border-bottom brc__transparent">Downloads</a>--}}
      {{--      </li>--}}
      <li class="nav-item">
        <a href="#product_cart"
           class="nav-link open__regular text_size__md px-0 py-2 mx-3 c__white c_h__white border-bottom brc__transparent">Team</a>
      </li>
      <li class="nav-item">
        <a href="#software"
           class="nav-link open__regular text_size__md px-0 py-2 mx-3 c__white c_h__white border-bottom brc__transparent">BIM
          & Technologies</a>
      </li>
    </ul>
  </div>
  ...
  <div class="row d-flex justify-content-center mx-0 px-0">
      ...
      <div class="d-flex justify-content-lg-start justify-content-sm-between align-items-center" style="height: 100px;">
        ...
        <div class="top_contacts col-sm-auto d-lg-none">
          <a href="#" onclick="return false"
             class="callback_modal_btn button border-0 open__semibold text_size__md px-4 py-1 contact-top contact-button ">Request
            a Call</a>
          <a href="#contacts"
             class="button border-0 open__semibold text_size__md c__black bgc__yellow bgc_h__yellow px-4 py-1 contact-button ">Contact
            Us</a>
        </div>
      </div>
    </div>
    <div class="d-none d-lg-block col-lg-auto">
      <ul class="nav d-flex justify-content-center align-items-center" style="height: 100px;">
        <li class="nav-item">
          <a href="#services"
             class="nav-link open__regular text_size__md px-lg-1 px-xl-3 c__white c_h__white border-bottom brc__transparent">Services</a>
        </li>
        <li class="nav-item">
          <a href="#works"
             class="nav-link open__regular text_size__md px-lg-1 px-xl-3 c__white c_h__white border-bottom brc__transparent">Portfolio</a>
        </li>
        <li class="nav-item">
          <a href="#inforgraphic"
             class="nav-link open__regular text_size__md px-lg-1 px-xl-3 c__white c_h__white border-bottom brc__transparent">Benefits</a>
        </li>
        <li class="nav-item">
          <a href="#guarantees"
             class="nav-link open__regular text_size__md px-lg-1 px-xl-3 c__white c_h__white border-bottom brc__transparent">Warranties</a>
        </li>
{{--        <li class="nav-item">--}}
        {{--          <a href="#download"--}}
        {{--             class="nav-link open__regular text_size__md px-lg-1 px-xl-3 c__white c_h__white border-bottom brc__transparent">Downloads</a>--}}
        {{--        </li>--}}
        <li class="nav-item">
          <a href="#product_cart"
             class="nav-link open__regular text_size__md px-lg-1 px-xl-3 c__white c_h__white border-bottom brc__transparent">Team</a>
        </li>
        <li class="nav-item">
          <a href="#software"
             class="nav-link open__regular text_size__md px-lg-1 px-xl-3 c__white c_h__white border-bottom brc__transparent">BIM
            & Technologies</a>
        </li>
      </ul>
    </div>
    <div class="col-2 d-lg-none">
      <ul class="nav d-flex justify-content-end align-items-center" style="height: 100px;">
        <li class="nav-item"><a href="#" id="bars" onclick="return false" class="nav-link c__white c_h__yellow"><i
  ...
  <div class="banner-slider">
    <div class="video-bg">
      <video width="100%" height="auto" preload="auto" autoplay loop muted playsinline>
        <source src="img/banner-video-1.mp4" type="video/mp4" />
        <source src="img/banner-video-1.ogg" type="video/ogg" />
        <source src="img/banner-video-1.webm" type="video/webm" />
      </video>
    ...
    <div class="video-bg">
      <div class="banner-slider__image" style="background-image: url('img/banner-img-3.jpg');"></div>
      <div class="container d-flex align-items-center" style="height: 100%;">
        <div class="col-12 text-left text-lg-center wow fadeInUp">
          <h1 class="montserrat__bold first-screen-h title_size__lg c__white text-center my-5" style="line-height: 1.5;">
            SUPPORT UKRAINE AND LET US HELP YOUR BUSINESS. <br>
    ...
    <div class="video-bg">
      <div class="banner-slider__image" style="background-image: url('img/banner-img-2.jpg');"></div>
      <div class="container d-flex align-items-center" style="height: 100%;">
        <div class="col-12 text-left text-lg-center wow fadeInUp">
          <h1 class="montserrat__bold first-screen-h title_size__lg c__white text-center my-5" style="line-height: 1.5;">
            SUPPORT UKRAINE AND LET US HELP YOUR BUSINESS. <br>
  ...
  <div class="container wow fadeInUp">
    <div class="row services__all">
      @foreach($services as $service)
        <div class="@if($service->pre_style == 'lg') col-lg-6 @else col-lg-4 @endif service__block service_btn"
      ...
      <div class="service-description-wrapper">
        ...
        <div class="service__content">
          <div class="pb-sm-2 font-weight-bold">Design Package development under supervision of your Project Architect
            (software to comply with the one used in the head office)
          </div>
          <p>Our highly experienced and educated CAD Drafter will suit your needs. Our Architect will develop drawings
            following your assignments and will introduce changes according to your remarks. You will have an
            opportunity to follow the process of work closely and introduce immediate changes together with
            Architect.</p>
          ...
          <div class="service__back_button open__bold c__black text_size__md border brc__metal brc_h__black px-3 py-1">
            Back
          </div>
        </div>
      </div>
...
<section id="inforgraphic" class="container-fluid py-5">
  <div class="container wow fadeInUp">
    <div class="col-12 pb-3">
      <h1 class="montserrat__bold title_size__xl text-center no-capitalize">Just Compare <br/> Staff And Operating
        Expenses</h1>
    </div>
    ...
    <div class="row flex-wrap">
      <div class="col-lg-4 col-sm-5">
        <div class="benefits-item">
          ...
          <p>The majority of technical personnel – skillful and qualified graduates and specialists – is outsourced at
            twice lower salary rates than your local ones.</p>
        </div>
      </div>
      <div class="col-lg-4 col-sm-5">
        <div class="benefits-item">
          ...
          <p>Smaller quantity of office space, desktops, equipment, software & hardware is needed, as well as less
            workload for HR and Finance departments.</p>
        </div>
      </div>
      <div class="col-lg-4 col-sm-5">
        <div class="benefits-item">
          ...
          <p>Immediate outsource team mobilization allows you to stick to the predictable permanent size of your head
            office team.</p>
        </div>
      </div>
      <div class="col-lg-4 col-sm-5">
        <div class="benefits-item">
          ...
          <p>Providing the appropriate design solutions in accordance with the local market needs and regulation
            requirements while working in the CIS area.</p>
        </div>
      </div>
      <div class="col-lg-4 col-sm-5">
        <div class="benefits-item">
          ...
          <p>Two benefits regarding the higher probability of winning the competition: on the one hand, cost saving on
            business trips and additional expenses; on the other hand, the warranty of the initial design concept
            preservation up to the delivery stage.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row flex-wrap">
      <div class="col-lg-6">
        <div class="benefits-item">
          ...
          <p>For certain kinds of contract terms, service types, design contents and program conditions, we are able to
            provide Performance Bond or Advance Payment Bond to ensure the job delivery.</p>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="benefits-item">
          ...
          <p>We are able to provide PI insurance of an appropriate level in accordance with the certain project, its
            possible risks and types of service provided.</p>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="benefits-item">
          <h3>03</h3>
          <h4>Control</h4>
          <p>We use Microsoft 365 for Task Management and Reporting purposes, so your representative can be a part of
            the process and have an online tool for control and reporting requests from the resources involved.</p>
          <p>Having access to BIM cloud services you will be able not only to view the model but also to see the online
            design process with the possibility to extract an instant report with the data of the project progress and
            the actual amount of time each team member has spent on work.</p>
          <p>For outstaffing employees of non-BIM services, we provide software that allows you to track working time
            and visualize the work process by random screen capturing.</p>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="benefits-item">
          ...
          <p class="dfn">We also practice doing a test job free of charge in order to show our competency, express our
            interest in cooperation and willingness to work.</p>
          <p>Having our representative in the Netherlands and taking into account the fact that we will become a
            registered company within two months, you will interact with the authorized company having its bank account
            in the CEE area and operating under European jurisdiction.</p>
        </div>
      </div>
    </div>
  </div>
...
<section id="product_cart" class="container-fluid py-5">
  <div class="container">
    <div class="col-12 pb-0 pb-lg-5 wow fadeInUp">
      <h1 class="montserrat__bold title_size__xl text-center no-capitalize">All Necessary Specialists and Software in
        One Office</h1>
    </div>
    ...
    <div class="col-12 wow fadeInUp team team__mobile_col">
      ...
      <div class="worker-description__wrapper">
        <div class="worker-description">
          ...
          <p class="description_text">In compliance with your requirements, our Architectural Designer will take part in
            the development of the project or its part under the guidance of your Project Architect both during the
            concept stage and the stage of working drawings.</p>
        </div>
      </div>
    </div>
...
{{--            @if($work->small_image)--}}
{{--              <a href="/#works-{{ $work->id }}" class="worker__portfolio_item worker__portfolio_1"--}}
{{--                 style="background-image: url({{ asset('storage/' . $work->small_image )}})">--}}
{{--                <p>{{ $work->name }}</p>--}}
{{--              </a>--}}
{{--            @endif--}}
{{--          @endforeach--}}
    ...
    <div class="col-12 wow fadeInUp">
      <div class="d-flex flex-column align-items-center justify-content-center mb-4">
        ...
        <div class="bim__video_wrapper">
          <iframe class="bim__video" width="60%" height="100%" src="https://www.youtube.com/embed/M5pm50IZsDc"
      ...
      <div class="d-flex flex-column align-items-center justify-content-center my-4">
        <div class="mx-4 order-2 order-md-1 param__modeling">
          ...
          <p class="txt text_size__md">Creation of complex surfaces, patterns, forms for interior design and
            architecture.</p>
          <p class="txt text_size__md">Analysis and automatic modelling of the illumination cone, automatic illustrative
            calculation of insolation for any area and real estate development.</p>
          <p class="txt text_size__md">Automatic change of room layouts and furniture placement due to the changing the
            contour of external walls, the shift of communication lines.</p>
          <p class="txt text_size__md">Analysis of the territory, vehicular flow and foot traffic, restrictions on
            insolation and automated obtainment of the maximum possible building volume.</p>
        ...
        <form id="callback_form" class="form_callback px-0 px-sm-5 py-4" method="POST" action="{{ route('contacts') }}"
          ...
          <div class="text-center mt-0 mb-3">
            <label for="callback_user_name"
                   class="form_label open__semibold c__black text_size__md text-left mb-0">* Name<br/>
              <input type="text" name="name" required id="callback_user_name"
                     class="form_input open__light c__black text_size__md border brc__metal brc_h__yellow bgc__transparent px-3 py-1 border-radius-5"
                     placeholder="Enter your name">
            </label>
            <label for="callback_user_email mt-2"
                   class="form_label open__semibold c__black text_size__md text-left mt-2 mb-0">* E-mail<br/>
              <input type="email" name="email" required id="callback_user_email"
                     class="form_input open__light c__black text_size__md border brc__metal brc_h__yellow bgc__transparent px-3 py-1 border-radius-5"
                     placeholder="Enter your e-mail">
            </label>
            <label for="callback_user_phone" class="form_label form_label_phone open__semibold c__black text_size__md text-left mt-2 mb-0">Contact
              phone number<br/>
              <input type="phone" id="callback_user_phone"
                     class="form_input open__light c__black border brc__metal brc_h__yellow bgc__transparent px-3 py-1 border-radius-5"
                     name="phone" placeholder="+__ (___) ___ __ __">
            </label>
          </div>
          <div class="text-center my-2">
            <textarea name="description"
                      class="form_textarea task__field border open__light text_size__md c__black brc__metal brc_h__yellow bgc__transparent px-3 py-1 border-radius-5"
                      rows="8" cols="80" placeholder="Description"></textarea>
          </div>
          <div class="text-center my-0">
            <div
                class="service-choice__button open__bold c__black text_size__md border brc__metal brc_h__black px-3 py-1">
              Choose a service <span>></span></div>
          </div>
          ...
          <div class="text-center my-0">
            ...
            <label for="callback_user_file"
                   class="form_input open__light c__black border brc__metal brc_h__yellow text_size__md  bgc__transparent px-3 py-1 mt-2 text-left border-radius-5"
                   style="max-width:100%;">Upload a test assignment</label>
          </div>
          <div class="text-center d-flex justify-content-center my-3">
            <div class="form_textarea">
              <input type="hidden" name="type" value="{{ App\Contact::TYPE_ORDER }}"/>
              <button type="submit"
                      class="button border-0 open__semibold text_size__md c__black bgc__yellow bgc_h__yellow px-3 px-sm-5 py-3"
                      style="text-transform: uppercase; font-weight: bold;">Get an offer
              </button>
            </div>
          </div>
        </form>
...
{{--        <div class="my-3">--}}
{{--          <a href="#contacts"--}}
{{--             class="button border-0 rounded open__semibold text_size__xl text-warning c__black bgc__black bgc_h__black px-4 py-3"--}}
{{--             style="display:table;margin:0 auto;min-width:100%;text-align:center;padding:25px 0 !important; font-weight: bold">Request--}}
{{--            a BIM Model</a>--}}
{{--        </div>--}}
{{--      </div>--}}
{{--      <div class="col-sm-12 col-lg-4">--}}
{{--        <div class="my-3">--}}
{{--          <a href="#contacts"--}}
{{--             class="button border-0 rounded open__semibold text_size__xl c__black bgc__black text-warning bgc_h__black px-4 py-3"--}}
{{--             style="display:table;margin:0 auto;min-width:100%;text-align:center;padding:25px 0 !important; font-weight: bold">Request--}}
{{--            a Drawing Sample</a>--}}
{{--        </div>--}}
{{--      </div>--}}
{{--      <div class="col-sm-12 col-lg-4">--}}
{{--        <div class="my-3">--}}
{{--          <a href="/files/DHI_Outsourcing_Services_LOI_Generic.pdf" download target="_blank"--}}
{{--             class="button border-0 rounded open__semibold text_size__xl c__black text-warning bgc__black bgc_h__black px-4 py-3"--}}
{{--             style="display:table;margin:0 auto;min-width:100%;text-align:center;padding:25px 0 !important; font-weight: bold">Download--}}
{{--            a Competency Statement</a>--}}
{{--        </div>--}}
{{--      </div>--}}
{{--    </div>--}}
{{--  </div>--}}
...
{{--  <div class="container">--}}
{{--    <div class="col-12 pb-0 pb-lg-5 wow fadeInUp">--}}
{{--      <h1 class="montserrat__bold title_size__xl text-center no-capitalize">We will Do a Free Test Assignment for--}}
{{--        You</h1>--}}
{{--    </div>--}}
{{--    <div class="col-12 wow fadeInUp">--}}
{{--      <div class="d-flex justify-content-center border brc__black">--}}
{{--        <form id="bid_form" class="form_bid px-5 py-4" method="POST" action="{{ route('contacts') }}"--}}
{{--              enctype="multipart/form-data">--}}
...
{{--          <div class="text-center my-3">--}}
{{--            <input type="text" name="name"--}}
{{--                   class="form_input open__light text_size__md c__metal border brc__metal brc_h__yellow px-3 py-1"--}}
{{--                   placeholder="Your name">--}}
{{--          </div>--}}
{{--          <div class="text-center my-0">--}}
{{--            <div--}}
...
{{--            <label for="bid_user_file"--}}
{{--                   class="form_input open__light text_size__md c__metal border brc__metal brc_h__yellow px-3 py-1 text-left">Upload--}}
{{--              a test assignment</label>--}}
{{--          </div>--}}
{{--          <div class="text-center mt-0">--}}
{{--            <label for="bid_user_phone" class="form_label open__semibold text_size__md c__metal text-left mb-0">Contact--}}
{{--              phone number</label><br/>--}}
{{--            <input type="text" id="bid_user_phone" name="phone"--}}
{{--                   class="form_input open__light text_size__md c__metal border brc__metal brc_h__yellow px-3 py-1"--}}
{{--                   placeholder="+__ (___) ___ __ __">--}}
{{--          </div>--}}
{{--          <div class="text-center mt-0">--}}
{{--            <label for="bid_user_email"--}}
{{--                   class="form_label open__semibold text_size__md c__metal text-left mb-0">E-mail</label><br/>--}}
{{--            <input type="text" id="bid_user_email" name="email"--}}
{{--                   class="form_input open__light text_size__md c__metal border brc__metal brc_h__yellow px-3 py-1"--}}
{{--                   placeholder="Your e-mail">--}}
{{--          </div>--}}
{{--          <div class="text-center my-3">--}}
...
{{--            <button type="submit"--}}
{{--                    class="button border-0 open__semibold text_size__md c__black bgc__yellow bgc_h__yellow px-3 px-sm-5 py-2">--}}
{{--              Submit--}}
{{--            </button>--}}
{{--          </div>--}}
{{--        </form>--}}
...
{{--    <div class="col-12">--}}
{{--      <div class="d-flex justify-content-center border brc__black">--}}
{{--        <form id="calculation_form" class="form_calculation px-5 py-4" method="POST" action="{{ route('contacts') }}"--}}
{{--              enctype="multipart/form-data">--}}
...
{{--          </p>--}}
{{--          <div class="text-center my-2">--}}
{{--            <label for="calculation_user_name" class="form_label open__semibold c__metal text_size__md text-left mb-0">Enter--}}
{{--              Your Name</label><br/>--}}
{{--            <input required type="text" name="name" id="calculation_user_name"--}}
{{--                   class="form_input open__light text_size__md c__metal border brc__metal brc_h__yellow px-3 py-1">--}}
{{--          </div>--}}
{{--          <div class="text-center my-2">--}}
{{--            <label for="calculation_user_email" class="form_label open__semibold text_size__md c__metal text-left mb-0">E-mail</label><br/>--}}
{{--            <input type="email" name="email" id="calculation_user_email"--}}
{{--                   class="form_input open__light c__metal text_size__md border brc__metal brc_h__yellow px-3 py-1">--}}
{{--          </div>--}}
{{--          <div class="text-center mt-3 mb-0">--}}
{{--            <input type="file" id="calculation_user_file" name="file" onchange="uploadFile(this)">--}}
{{--            <label for="calculation_user_file"--}}
{{--                   class="form_input open__light text_size__md c__metal border brc__metal brc_h__yellow px-3 py-1 text-left">Upload--}}
{{--              a test assignment</label>--}}
{{--          </div>--}}
{{--          <div class="text-center mt-0 mb-3">--}}
{{--            <label for="calculation_user_phone" class="form_label open__semibold text_size__md c__metal text-left mb-0">Contact--}}
{{--              phone number for clarification of details</label><br/>--}}
{{--            <input type="text" name="phone" id="calculation_user_phone"--}}
{{--                   class="form_input open__light c__metal text_size__md border brc__metal brc_h__yellow px-3 py-1"--}}
{{--                   placeholder="+__ (___) ___ __ __">--}}
{{--          </div>--}}
{{--          <div class="text-center my-3">--}}
...
<footer id="footer" class="container-fluid bgc__graphite c__white px-0 mx-0">
