...
<section id="works" class="container-fluid bgc__grey py-5">
    <div class="container portfolio__lg">
        ...
        <div class="wall-tabs col-12 wow fadeInUp">
            <ul class="tabs_buttons d-flex flex-column flex-sm-row justify-content-between px-0" style="list-style-type: none;">
                @foreach($categories as $category) @if($category->works->count())
                    <li class="button portfolio__tab_button border-0 open__semibold text_size__md c__black bgc_h__yellow px-2 px-md-3 px-lg-5 py-2 my-2 my-sm-0
                        @if ($loop->first)bgc__active @endif"><span>{{ $category->name }}</span></li>
                @endif
                @endforeach
            </ul>
            @foreach($categories as $category) @if($category->works->count())
                <div class="portfolio__slick_outer wall wall_tab @if ($loop->first)wall_tab__active @endif">
                    @foreach($category->works as $work)
                        ...
                        @endif
                        <div class="portfolio__item" id="portfolio__item_1" style="background-image: url({{ asset('storage/' . $work->cover) }});">
                            <div class="portfolio__item_inner">
                                <h3 class="block_title open__semibold text_size__md text-center c__white w-100">{{ $work->name }}</h3>
                                <button type="button" class="modal__open_button button border-0 open__semibold text_size__md c__black bgc__yellow bgc_h__yellow mt-lg-3 px-3 px-lg-5 py-2">@lang('Подробнее')</button>
                            </div>
                        </div>
                    @endforeach
                    </div></div>
    ...
    <div class="container portfolio__mobile">
        <div class="col-12 pb-0 pb-lg-5 wow fadeInUp">
            <h1 class="montserrat__bold title_size__xl text-center">Работы мирового уровня</h1>
        </div>
        <div class="wall-tabs col-12 wow fadeInUp">
            <ul class="tabs_buttons d-flex flex-column flex-sm-row justify-content-between px-0" style="list-style-type: none;">
                <li class="button portfolio__tab_button border-0 open__semibold text_size__md c__black bgc_h__yellow px-2 px-md-3 px-lg-5 py-2 my-2 my-sm-0 bgc__active">Фильтр 1</li>
                <li class="button portfolio__tab_button border-0 open__semibold text_size__md c__black bgc_h__yellow px-2 px-md-3 px-lg-5 py-2 my-2 my-sm-0">Фильтр 2</li>
                <li class="button portfolio__tab_button border-0 open__semibold text_size__md c__black bgc_h__yellow px-2 px-md-3 px-lg-5 py-2 my-2 my-sm-0">Чертежи</li>
                <li class="button portfolio__tab_button border-0 open__semibold text_size__md c__black bgc_h__yellow px-2 px-md-3 px-lg-5 py-2 my-2 my-sm-0">3D модели</li>
                <li class="button portfolio__tab_button border-0 open__semibold text_size__md c__black bgc_h__yellow px-2 px-md-3 px-lg-5 py-2 my-2 my-sm-0">Дизайн интерьера</li>
            </ul>
            <div class="portfolio__slick_outer wall wall_tab wall_tab__active">
                <div class="portfolio__slide_container">
                    <div class="portfolio__slide_wrapper">
                        <div class="portfolio__item portfolio__item_lg" id="portfolio__item_1" style="background-image: url(img/work_1.png);">
                            <div class="portfolio__item_inner">
                                <h3 class="block_title open__semibold text_size__md text-center c__white w-100">CAD Drafting 01 / Design Package development under<br /> supervision of LJA’s Project Architect</h3>
                                <button type="button" class="modal__open_button button border-0 open__semibold text_size__md c__black bgc__yellow bgc_h__yellow mt-lg-3 px-3 px-lg-5 py-2">Подробнее</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="portfolio__slide_container">
                    <div class="portfolio__slide_wrapper">
                        <div class="portfolio__item" id="portfolio__item_1" style="background-image: url(img/work_2.png);">
                            <div class="portfolio__item_inner">
                                <h3 class="block_title open__semibold text_size__md text-center c__white w-100">CAD Drafting 01 / Design Package development under<br /> supervision of LJA’s Project Architect</h3>
                                <button type="button" class="modal__open_button button border-0 open__semibold text_size__md c__black bgc__yellow bgc_h__yellow mt-lg-3 px-3 px-lg-5 py-2">Подробнее</button>
                            </div>
                ...
                <div class="portfolio__slide_container">
                    <div class="portfolio__slide_wrapper">
                        <div class="portfolio__item" id="portfolio__item_1" style="background-image: url(img/work_3.png);">
                            <div class="portfolio__item_inner">
                                <h3 class="block_title open__semibold text_size__md text-center c__white w-100">CAD Drafting 01 / Design Package development under<br /> supervision of LJA’s Project Architect</h3>
                                <button type="button" class="modal__open_button button border-0 open__semibold text_size__md c__black bgc__yellow bgc_h__yellow mt-lg-3 px-3 px-lg-5 py-2">Подробнее</button>
                            </div>
                ...
                <div class="portfolio__slide_container">
                    <div class="portfolio__slide_wrapper">
                        <div class="portfolio__item" id="portfolio__item_1" style="background-image: url(img/work_4.png);">
                            <div class="portfolio__item_inner">
                                <h3 class="block_title open__semibold text_size__md text-center c__white w-100">CAD Drafting 01 / Design Package development under<br /> supervision of LJA’s Project Architect</h3>
                                <button type="button" class="modal__open_button button border-0 open__semibold text_size__md c__black bgc__yellow bgc_h__yellow mt-lg-3 px-3 px-lg-5 py-2">Подробнее</button>
                            </div>
                ...
                <div class="portfolio__slide_container">
                    <div class="portfolio__slide_wrapper">
                        <div class="portfolio__item" id="portfolio__item_1" style="background-image: url(img/work_5.png);">
                            <div class="portfolio__item_inner">
                                <h3 class="block_title open__semibold text_size__md text-center c__white w-100">CAD Drafting 01 / Design Package development under<br /> supervision of LJA’s Project Architect</h3>
                                <button type="button" class="modal__open_button button border-0 open__semibold text_size__md c__black bgc__yellow bgc_h__yellow mt-lg-3 px-3 px-lg-5 py-2">Подробнее</button>
                            </div>
                ...
                <div class="portfolio__slide_container">
                    <div class="portfolio__slide_wrapper">
                        <div class="portfolio__item portfolio__item_lg" id="portfolio__item_1" style="background-image: url(img/work_6.png);">
                            <div class="portfolio__item_inner">
                                <h3 class="block_title open__semibold text_size__md text-center c__white w-100">CAD Drafting 01 / Design Package development under<br /> supervision of LJA’s Project Architect</h3>
                                <button type="button" class="modal__open_button button border-0 open__semibold text_size__md c__black bgc__yellow bgc_h__yellow mt-lg-3 px-3 px-lg-5 py-2">Подробнее</button>
                            </div>
