      ...
      <div class="portfolio__slide_container"><div class="portfolio__slide_wrapper">
          ...
          <div class="portfolio__item modal__open_button" style="background-image: url({{ asset('storage/' . $work->cover) }});" data-id="{{ $work->id }}">
            <div class="portfolio__item_inner">
              ...
              <button type="button" class="button border-0 open__semibold text_size__md c__black bgc__yellow bgc_h__yellow mt-lg-3 px-3 px-lg-5 py-2">@lang('Подробнее')</button>
            </div>
          </div>
          @endforeach
      </div></div>
    ...
    <div class="portfolio__slick_outer wall wall_tab">
      <div class="portfolio__slide_container"><div class="portfolio__slide_wrapper">
          ...
          <div class="portfolio__item modal__open_button" style="background-image: url({{ asset('storage/' . $work->cover) }});" data-id="{{ $work->id }}">
            <div class="portfolio__item_inner">
              <h3 class="block_title open__semibold text_size__md text-center c__white w-100">{{ $work->name }}</h3>
              <button type="button" class="button border-0 open__semibold text_size__md c__black bgc__yellow bgc_h__yellow mt-lg-3 px-3 px-lg-5 py-2" data-id="{{ $work->id }}">@lang('Подробнее')</button>
            </div>
          </div>
          @endforeach
        </div></div>
